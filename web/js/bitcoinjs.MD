...
...as per this page...
https://coinpunk.github.io/bitcoinjs-lib/
...except that I changed the first letter in `bitcoin` to lower case to match the examples in the bitcoinjs documentation. 
